...
class HomeReviewCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        receiverEmailLabel.anchor(top: nil, left: leftAnchor, bottom: receiverProfileImageView.bottomAnchor, right: receiverProfileImageView.leftAnchor, paddingTop: 0, paddingLeft: 12, paddingBottom: 0, paddingRight: 8, width: 0, height: 0)
        
        addSubview(receiverFullnameLabel)
        receiverFullnameLabel.anchor(top: nil, left: leftAnchor, bottom: receiverEmailLabel.topAnchor, right: receiverEmailLabel.rightAnchor, paddingTop: 0, paddingLeft: 12, paddingBottom: 0, paddingRight: 0, width: 0, height: 0)
